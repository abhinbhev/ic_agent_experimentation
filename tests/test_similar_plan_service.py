...
def test_search_returns_root_cause_pattern(sample_domain_config, sample_score_fusion_weights, stub_embedding_backend):
    ...
    assert top.pattern_id == "root_cause_metric_change"
    assert 0.0 <= top.confidence <= 1.0
    assert top.probe_strategy == ["trend", "decomposition", "segment analysis", "driver analysis"]
